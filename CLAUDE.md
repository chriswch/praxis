...
- Build each fresh worker context from `praxis build-worker-launch --repo-root .` after installing the repo in editable mode or bootstrapping `src/` onto `PYTHONPATH`.
