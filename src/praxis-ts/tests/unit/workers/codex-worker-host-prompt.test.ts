...
import { buildStagePrompt } from "../../../src/runtime/workers/codex-worker-host.js";
...
void test("AC-2: mapped stage — lines 2..N carry today's Codex prompt block verbatim (no writeback sentence)", () => {
