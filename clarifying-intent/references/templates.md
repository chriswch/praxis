...
- **Feature Brief**: Use for large / epic-sized inputs that will be split into multiple stories. Captures goals, boundaries, and slicing strategy. Hand off to `slicing-stories` afterward.
