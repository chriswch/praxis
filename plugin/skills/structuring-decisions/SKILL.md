...
- **The catalog is a toolbox, not a checklist.** Pull the few methods that fit; never march through all 230. Cite the method you used so the reasoning is traceable.
