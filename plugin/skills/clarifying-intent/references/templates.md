...
- **Feature Brief**: Use for large / epic-sized inputs that will be split into multiple stories. Captures goals, boundaries, and slicing strategy. Continue with `slicing-stories` afterward.
