...
import { ChildCraftRunSeeder } from "./child-craft-run-seeder.js";
import {
...
export class ConvergePassService {
  private readonly childSeeder: ChildCraftRunSeeder;

  constructor(
    private readonly repo: PraxisStateRepository,
    private readonly childRunSlot: ChildRunSlotService,
  ) {
    this.childSeeder = new ChildCraftRunSeeder(repo, childRunSlot);
  }
  ...
  private async launchChildCraftRun(
    ...
    return this.childSeeder.launch(campaign, passId, remediationMap);
  }
}
